...
export default function Footer() {
    return (
        <footer className="bg-wood-950 text-wood-400">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    {/* Brand */}
                    <div className="md:col-span-1">
                        <div className="flex items-center gap-2 mb-3">
                            <Heart className="w-5 h-5 text-wood-400" />
                            <span className="text-lg font-bold text-white">
                                Heal<span className="text-beige-400">Hive</span>
                            </span>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-1.5">
                                <Shield className="w-3.5 h-3.5 text-beige-400" />
                ...
                <div className="border-t border-wood-900 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
                    <p className="text-xs">
